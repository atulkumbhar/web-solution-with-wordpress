...
By now you should know how to spin up an EC2 instanse on AWS, but if you forgot - refer to WEB STACK IMPLEMENTATION Step 0. In previous projects we used ‘Ubuntu’, but it is better to be well-versed with various Linux distributions, thus, for this projects we will use very popular distribution called ‘RedHat’ (it also has a fully compatible derivative - CentOS)
